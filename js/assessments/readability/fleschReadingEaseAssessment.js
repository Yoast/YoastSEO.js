...
var FleschReadingEaseAssessment = (function () {
    function FleschReadingEaseAssessment() {
        this.identifier = "fleschReadingEase";
        this.getResult = fleschReadingEaseAssessment;
    }
    FleschReadingEaseAssessment.prototype.isApplicable = function (paper) {
