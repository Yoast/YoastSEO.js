...
let singleWords = [ "ändå", "annars", "ännu", "avslutningsvis", "bl.a.", "d.v.s.", "då", "därefter", "däremot", "därför",
	...
	"särskilt", "såsom", "sedan", "sist", "slutligen", "speciellt", "t.ex.", "tidigare", "tillika", "tills", "trots",
	"tvärtemot", "tvärtom", "tydligen", "vidare", "ytterligare" ];

let multipleWords = [ "å andra sidan", "å ena sidan", "allt som allt", "anledningen är", "anledningen blir", "annorlunda än",
	"av den orsaken", "av detta skäl", "även fast", "även om", "beroende på", "bland annat", "därtill kommer",
	"det beror på att", "det vill säga", "det visar", "detta beror på", "detta går ut på att", "detta innebär att",
	"detta medför att", "effekten blir", "efter ett tag", "ej heller", "en effekt av detta", "en förklaring till detta",
	"ett exempel på detta", "följden blir", "för all del", "för att", "för att klargöra", "för att poängtera",
	"för att säga det på ett annat sätt", "för att understryka", "för det andra", "för det första", "för det tredje",
	...
	"som konklusion kan", "som man kan se", "som nämnt", "som tidigare nämnts", "summa summarum", "till dess", "till exempel",
	"till följd av", "till sist", "tillsammans med", "tvärt om", "under de omständigheterna", "under tiden", "vad mera är",
	"viktigt att inse", "vilket innebär" ];
