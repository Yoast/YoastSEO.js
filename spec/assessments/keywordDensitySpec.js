...
describe( "An assessment for the keywordDensity", function() {
	it( "Returns 4 and a 'less than recommended' feedback string if the keyword count is 0", function() {
		...
		expect( result.getText() ).toBe( "<a href='https://yoa.st/2pe' target='_blank'>The focus keyword was found 0 times</a>. That's less than the recommended minimum of 2 times for a text of this length." );
	} );
	...
	it( "Returns 4 and a 'less than recommended' feedback string if the keyword density is lower than recommended (count: 1, singular feedback)", function() {
		...
		expect( result.getScore() ).toBe( 4 );
		expect( result.getText() ).toBe( "<a href='https://yoa.st/2pe' target='_blank'>The focus keyword was found 1 time</a>. That's less than the recommended minimum of 3 times for a text of this length." );
	} );
	...
	it( "Returns 4 and a 'less than recommended' feedback string if the keyword density is lower than recommended (count: >1, plural feedback)", function() {
		...
		expect( result.getScore() ).toBe( 4 );
		expect( result.getText() ).toBe( "<a href='https://yoa.st/2pe' target='_blank'>The focus keyword was found 2 times</a>. That's less than the recommended minimum of 3 times for a text of this length." );
	} );
	...
	it( "Returns -10 and a 'more than recommended' feedback string if the density is higher than recommended", function() {
		...
		expect( result.getText() ).toBe( "<a href='https://yoa.st/2pe' target='_blank'>The focus keyword was found 10 times</a>. That's more than the recommended maximum of 8 times for a text of this length." );
	} );
	...
	it( "Returns -50 and a 'way more than recommended' feedback string if the density is much higher than recommended", function() {
		...
		expect( result.getText() ).toBe( "<a href='https://yoa.st/2pe' target='_blank'>The focus keyword was found 12 times</a>. That's way more than the recommended maximum of 8 times for a text of this length." );
	} );
	...
	it( "Returns 9 and a 'great' feedback string if the density is within the recommended margin", function() {
		...
		expect( result.getText() ).toBe( "<a href='https://yoa.st/2pe' target='_blank'>The focus keyword was found 2 times</a>. That's great for a text of this length." );
	} );
	...
	it( "Returns 4 and a 'less than recommended' feedback string if the keyword appears only once in the text, regardless of the density", function() {
		...
		expect( result.getScore() ).toBe( 4 );
		expect( result.getText() ).toBe( "<a href='https://yoa.st/2pe' target='_blank'>The focus keyword was found 1 time</a>. That's less than the recommended minimum of 2 times for a text of this length." );
	} );
} );
