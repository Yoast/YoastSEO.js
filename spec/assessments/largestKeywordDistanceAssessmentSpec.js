...
describe( "An assessment to check the largest percentage of text in which no keyword occurs, synonyms not supplied", function() {
	it( "returns a bad score when the largest keyword distance is more than 50%", function() {
