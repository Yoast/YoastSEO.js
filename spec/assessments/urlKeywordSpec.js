...
describe( "A keyword in url count assessment", function() {
	it( "assesses no keyword was found in the url", function() {
		...
		expect( assessment.getText() ).toEqual( "The focus keyword does not appear in the " +
			"<a href='https://yoa.st/2pp' target='_blank'>URL</a> for this page. " +
	...
	it( "assesses a keyword was found in the url", function() {
		...
		expect( assessment.getText() ).toEqual( "The focus keyword appears in the " +
			"<a href='https://yoa.st/2pp' target='_blank'>URL</a> for this page." );
	} );
} );
