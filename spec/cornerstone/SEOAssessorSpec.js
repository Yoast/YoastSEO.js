...
describe ( "running assessments in the assessor", function() {
	...
	// These specifications will additionally trigger the keyword density assessment.
	it( "additionally runs assessments that require a text of at least 100 words and a keyword", function() {
		assessor.assess( new Paper( "This is a keyword. Lorem ipsum dolor sit amet, vim illum aeque constituam at." +
			" Id latine tritani alterum pro. Ei quod stet affert sed. Usu putent fabellas suavitate id. Quo ut stet" +
			" recusabo torquatos. Eum ridens possim expetenda te. Ex per putant comprehensam. At vel utinam cotidieque," +
			" at erat brute eum, velit percipit ius et. Has vidit accusata deterruisset ea, quod facete te vis. Vix ei" +
			" duis dolor, id eum sonet fabulas. Id vix imperdiet efficiantur. Percipit probatus pertinax te sit. Putant" +
			" intellegebat eu sit. Vix reque tation prompta id, ea quo labore viderer definiebas. Oratio vocibus offendit" +
			" an mei, est esse pericula liberavisse.", { keyword: "keyword" } ) );
	...
	it( "additionally runs assessments that require a text of at least 100 words, a keyword, and two keyword occurrences", function() {
